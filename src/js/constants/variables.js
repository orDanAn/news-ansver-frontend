...
const popupOpen = document.querySelector('#authButton');
...
const templateNotFound = document.querySelector('#not-found');
const headerLink = document.querySelector('#saved-articles');
const logOutButton = document.querySelector('#logOutButton');
const menuMobile = document.querySelector('#menu-mobile');
const buttonMenu = document.querySelector('.button-menu');
const headerLinkMobile = document.querySelector('#saved-articles-mobile');
const popupOpenMomile = document.querySelector('#authButton-mobile');
const logOutButtonMobile = document.querySelector('#logOutButton-mobile');
